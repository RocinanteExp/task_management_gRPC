            ...
            API.addTask(task)
                .then(() => {
                    ...
                    API.getTasks().then((tasks) =>
                        this.setState({ tasks: tasks, filter: "All", projects: this.getProjects(tasks) })
                    );
                })
                .catch((errorObj) => {
                    this.handleErrors(errorObj);
                        ...
                        <Route path="/tasks">
                            <Row className="vheight-100">
                                ...
                                <Col sm={8} className="below-nav">
                                    ...
                                    />
                                    <Link to="/add">
                                        <Button variant="success" size="lg" className="fixed-right-bottom">
                                            &#43;
                                        </Button>
                                    </Link>
                                </Col>
